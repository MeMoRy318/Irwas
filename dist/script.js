...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _checkNumberImput__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./checkNumberImput */ "./src/js/modules/checkNumberImput.js");
...
const changeModalState = state => {
  ...
  const handleInputChange = (event, state, property) => {
    ...
    (0,_checkNumberImput__WEBPACK_IMPORTED_MODULE_0__["default"])(target);
...
/***/ "./src/js/modules/checkNumberImput.js":
/*!********************************************!*\
  !*** ./src/js/modules/checkNumberImput.js ***!
  \********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (checkNumberImput);
...
const forms = (state = {}) => {
  ...
  const handlePhoneInput = event => {
    ...
    (0,_checkNumberImput__WEBPACK_IMPORTED_MODULE_0__["default"])(input);
  };
  forms.forEach(form => {
...
const images = () => {
  ...
  works.addEventListener('click', event => {
    ...
    if (target && target.classList.contains('preview')) {
      ...
      document.body.style.marginRight = `${(0,_modals__WEBPACK_IMPORTED_MODULE_0__.calckScroll)()}px`;
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   calckScroll: () => (/* binding */ calckScroll),
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _addZero__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./addZero */ "./src/js/modules/addZero.js");

const timer = deadline => {
  const getTime = () => {
    const time = (Date.parse(deadline) - new Date()) / 1000;
    const seconds = (0,_addZero__WEBPACK_IMPORTED_MODULE_0__["default"])(Math.floor(time % 60));
    const minutes = (0,_addZero__WEBPACK_IMPORTED_MODULE_0__["default"])(Math.floor(time / 60 % 60));
    const hours = (0,_addZero__WEBPACK_IMPORTED_MODULE_0__["default"])(Math.floor(time / 60 / 60 % 24));
    const days = (0,_addZero__WEBPACK_IMPORTED_MODULE_0__["default"])(Math.floor(time / 60 / 60 / 24));
    return {
      time,
      seconds,
      minutes,
...
/* harmony import */ var _modules_changeModalState__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/changeModalState */ "./src/js/modules/changeModalState.js");
...
window.addEventListener('DOMContentLoaded', () => {
  ...
  const modalState = {};
  (0,_modules_changeModalState__WEBPACK_IMPORTED_MODULE_1__["default"])(modalState);
  // MODALS

  (0,_modules_modals__WEBPACK_IMPORTED_MODULE_4__.openModal)('.header_btn', '.popup_engineer');
  (0,_modules_modals__WEBPACK_IMPORTED_MODULE_4__.openModal)('.phone_link', '.popup');
  (0,_modules_modals__WEBPACK_IMPORTED_MODULE_4__.openModal)('.popup_calc_btn', '.popup_calc');
  (0,_modules_modals__WEBPACK_IMPORTED_MODULE_4__.openModal)('.popup_calc_content .popup_calc_button', '.popup_calc_profile');
  (0,_modules_modals__WEBPACK_IMPORTED_MODULE_4__.openModal)('.popup_calc_profile_button', '.popup_calc_end');
  (0,_modules_modals__WEBPACK_IMPORTED_MODULE_4__.closeModal)('.popup_engineer .popup_close strong', '.popup_engineer');
  (0,_modules_modals__WEBPACK_IMPORTED_MODULE_4__.closeModal)('.popup .popup_close strong', '.popup');
  (0,_modules_modals__WEBPACK_IMPORTED_MODULE_4__.closeModal)('.popup_calc_close strong', '.popup_calc');
  (0,_modules_modals__WEBPACK_IMPORTED_MODULE_4__.closeModal)('.popup_dialog strong', '.popup_calc_profile');
  (0,_modules_modals__WEBPACK_IMPORTED_MODULE_4__.closeModal)('.popup_calc_end strong', '.popup_calc_end');

  // TABS

  (0,_modules_tabs__WEBPACK_IMPORTED_MODULE_5__["default"])('.glazing_slider ', '.glazing_block', '.glazing_content', 'active');
  (0,_modules_tabs__WEBPACK_IMPORTED_MODULE_5__["default"])('.decoration_slider', '.no_click', '.decoration_content > div > div', 'after_click');
  (0,_modules_tabs__WEBPACK_IMPORTED_MODULE_5__["default"])('.balcon_icons', '.balcon_icons_img', '.big_img > img', 'do_image_more');

  // FORMS
  (0,_modules_forms__WEBPACK_IMPORTED_MODULE_2__["default"])(modalState);

  // TIMER
  (0,_modules_timer__WEBPACK_IMPORTED_MODULE_6__["default"])(deadline);
